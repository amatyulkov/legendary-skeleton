...
var Skeleton = /** @class */ (function () {
    ...
    Skeleton.prototype.parseConfig = function (config) {
        ...
        var color = (_b = config.color) !== null && _b !== void 0 ? _b : "rgba(128, 128, 128, 0.1)";
        var highlight = (_c = config.highlight) !== null && _c !== void 0 ? _c : "rgba(128, 128, 128, 0.2)";
        var highlightWidth = (_d = config.highlightWidth) !== null && _d !== void 0 ? _d : 0.5;
        return {
            animationDuration: (_e = config.animationDuration) !== null && _e !== void 0 ? _e : 1000,
            highlightWidth: highlightWidth,
            namespace: namespace,
            partSelector: (_f = config.partSelector) !== null && _f !== void 0 ? _f : "[data-".concat(namespace, "]"),
            color: color,
            highlight: highlight,
            stops: (_g = config.stops) !== null && _g !== void 0 ? _g : [
                { offset: 0, color: color },
                { offset: highlightWidth / 2, color: highlight },
                { offset: highlightWidth, color: color },
            ]
        };
    };
